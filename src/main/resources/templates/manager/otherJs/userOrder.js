...
var getList=function(page,id,name){
	$.getJSON(url+"foodOrder/" + JSON.parse(da).id,{
		page:page,
		id:id,
		name:name
	},function(json){
...
var createTable=function(data)
{
	...
	var splice=["100","150","200","180","80","200"];
	...
	var headList=["订单编号","送达时间","配送地址","联系电话","订单状态"];
...
//主体部分放置数据
	...
	tdList[1].innerText=data[k].time;
	tdList[2].innerText=data[k].adress;
	tdList[3].innerText=data[k].phone;
	tdList[4].innerText=data[k].status;
